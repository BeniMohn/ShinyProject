                    ...
                    tabPanel("Description", 
                             ...
                             tabsetPanel(type="tabs",
                                         tabPanel("Input",
                                                  ...
                                                  "I will explain each of the element allone. The structure for this description will be always the same.",
                                                  ...
                                                  tabsetPanel(type="tabs",
                                                              ...
                                                              tabPanel("Features",
                                                                       ...
                                                                       "On the other hand, once two features are being choosen, all other choices will disappear.",
                                                                       "By this the user only can unselect a option and therefore not chose more than two colomns.",
                                                                       h5("Regressor"),
                                                                       "A field that is selected as feature can not be selected as regressor.",
                                                                       "Once a feature variable is selected, it will be removed from the possiblilities in the regressor.",
                                                                       "This could mean as well, that the current choosen regressor gets removed, in this case the first element will be selected as default.",
                                                                       h5("Start Calulation"),
                                                                       "Lastly this field has influence on the Start Calculation button. As long as no feature is selected, the button is hidden.",
                                                                       "By this approach the user is forced to select at least one feature, otherwise no model can be calculated."
                                                                       ),
                                                              tabPanel("Regressor",
                                                                       h4("General"),
                                                                       "This is a radio button input, therefore the user can only select one field here. This field will be the target variable in the prediction model.",
                                                              ...
                                                              tabPanel("Model",
                                                                       ...
                                                                       "Out of these 5 models two are valid for both classes, therefore the number of supplied models is 8.",
                                                              ...
                                                              tabPanel("Start Calculation",
                                                                       h4("General"),
                                                                       "This input is simply a button, which is starting the model fit process.",
                                         ...
                                         tabPanel("Output",
                                                  ...
                                                  tabsetPanel(type="tabs",
                                                              tabPanel("Result",
                                                                       ...
                                                                       "In order to get the table that is shown, the only thing you have to do is: model$results.",
                                                                       h4("Example"),
                                                                       tableOutput("exmapleTable")),
                                                              tabPanel("Model Info",
                                                                       h4("General"),
                                                                       "This output is holding some genreal information about the model that was fitted.",
                                                                       "As well this can differ quiete a lot from model to model.",
                                                              ...
                                                              tabPanel("Plot",
                                                                       ...
                                                                       br(), br(),
                                                                       "All that this plot is showing is the dataset as a scatter plot, where the x-axis is one of the features and the y-axis shows the other feature.",
                                                                       "The color of the dot, representing a observation, will tell you, whether or not the model predicted correctly the class of this observation.",
                                                                       h4("Examples"),
                                                                       h5("Residual Plot"),
                                                                       plotOutput("examplePlot1"),
                                                                       h5("Bar Plot"),
                                                                       plotOutput("examplePlot2"),
                                                                       h5("Scatter Plot"),
